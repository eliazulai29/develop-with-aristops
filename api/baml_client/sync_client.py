...
class BamlSyncClient:
    ...
    def AnalyzeCode(self, code: str,
        ...
        result = self.__options.merge_options(baml_options).call_function_sync(function_name="AnalyzeCode", args={
            "code": code,
        })
    ...
    def AnalyzeComplexity(self, component: types.CodeComponent,
        ...
        result = self.__options.merge_options(baml_options).call_function_sync(function_name="AnalyzeComplexity", args={
            "component": component,
        })
...
class BamlStreamClient:
    ...
    def AnalyzeCode(self, code: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.CodeAnalysis, types.CodeAnalysis]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="AnalyzeCode", args={
            "code": code,
        })
        return baml_py.BamlSyncStream[stream_types.CodeAnalysis, types.CodeAnalysis](
          result,
    ...
    def AnalyzeComplexity(self, component: types.CodeComponent,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="AnalyzeComplexity", args={
            "component": component,
        })
...
class BamlHttpRequestClient:
    ...
    def AnalyzeCode(self, code: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="AnalyzeCode", args={
            "code": code,
        }, mode="request")
        return result
    def AnalyzeComplexity(self, component: types.CodeComponent,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="AnalyzeComplexity", args={
            "component": component,
        }, mode="request")
        return result
